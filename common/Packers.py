...
class PackerDict(Packers):
    ...
    def unmarshall_return_value(self, return_value_as_json: dict) -> RpcReturnDesc:
        result_as_rpc_desc = RpcReturnDesc(return_value_as_json["result"],
...
if __name__ == "__main__":
    ...
    log.simple_log(f"{rv_from_dict} ={fxn_name}, {fxn_list}")
    ...
    log.simple_log(data_as_bytes, fxn_name, fxn_list)
